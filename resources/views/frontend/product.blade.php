                ...
                <div class="col-md-6">
                    <div id="slider" class="owl-carousel product-slider">
                        @foreach ($product->image as $image)
                            <div class="item">
                                <img src="{{ asset(Storage::url($image)) }}" alt="{{ $product->name }}" />
                            </div>
                        @endforeach
                        ...
                        <div class="product-info">
                            ...
                            @if ($product->discount > 0)
                                <div class="product-price-discount">
                                    <span>Rs.{{ $product->price - ($product->price * $product->discount) / 100 }}</span><span
                                        class="line-through">Rs.{{ $product->price }}</span>
                                </div>
                            @else
                                <div class="product-price-discount"><span>Rs.{{ $product->price }} </span></div>
                            @endif
                        </div>
